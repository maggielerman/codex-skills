...
```bash
python3 /Users/maggielerman/.codex/skills/ML-shopify-app-scaffold/scripts/scaffold_shopify_app.py --help
```

Typical command:

```bash
python3 /Users/maggielerman/.codex/skills/ML-shopify-app-scaffold/scripts/scaffold_shopify_app.py \
