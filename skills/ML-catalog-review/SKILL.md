...
If the repo already has `DOCS/development/ML-catalog-review-workflow.md` or `docs/development/ML-catalog-review-workflow.md`, use that file as the local source of truth first.
...
If the repo also has a docs-root evidence system such as `DOCS/evidence/templates/ML-catalog-review/` or `docs/evidence/templates/ML-catalog-review/`, treat that directory as the durable home for review-session templates and conventions.

If the repo does not yet have a docs system or ML-catalog-review scaffold, follow the workflow below directly.
...
A ML-catalog-review project should record:
...
Use a repo's generic project template for the project doc itself, and keep review-board-specific scaffolding under the docs root's `evidence/templates/ML-catalog-review/` area when the repo has one.
