...
```text
Use $user-journey-audit to create a current-state navigation audit for this repo.
...
```text
Use $user-journey-audit to audit the current-state journey for the Admin user in this repo.
...
```text
Use $user-journey-audit to audit the current-state journeys for these user types in this repo: Member, Admin, and Partner.
...
```text
Use $user-journey-audit to inspect this repo and suggest which user types should be included in a current-state navigation audit.
