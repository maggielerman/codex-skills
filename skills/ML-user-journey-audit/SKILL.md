...
```bash
python3 /Users/maggielerman/.codex/skills/ML-user-journey-audit/scripts/init_journey_audit_manifest.py \
...
```bash
node /Users/maggielerman/.codex/skills/ML-user-journey-audit/scripts/render_journey_audit_pdf.mjs \
