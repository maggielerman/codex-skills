...
Use these templates when creating missing docs in a docs-system scaffold workflow.
...
- **Lean canvas** (`lean-canvas.md`): business model snapshot.
...
## Status
- Last updated: {{LAST_UPDATED_DATE_ET}}
- Owner: {{OWNER_OR_TEAM}}
```
...
## Template
### {{LAST_UPDATED_DATE_ET}}: {{DECISION_TITLE}}
**Context:** {{CONTEXT}}
**Decision:** {{DECISION}}
