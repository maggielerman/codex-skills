...
Use this policy when a repo already has docs-system-scaffold governance and project tracking under `docs/PROJECTS/` or `DOCS/PROJECTS/`.
Use this skill only for repositories scaffolded before `docs-system-scaffold` included `in-review` and `blocked` by default.
