...
description: Transitional legacy patch for repositories that were scaffolded before docs-system-scaffold included `in-review` and `blocked` lifecycle states. Use only to retrofit those states and synchronized governance updates across project docs and instruction files.
---
...
Deprecation plan: once all active repositories have been migrated and `docs-system-scaffold` adoption is universal, retire this skill.
