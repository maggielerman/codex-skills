...
## New canonical path
Use `ML-product-operating-system-scaffold` instead. It now includes product-doc pack scaffolding directly.

## Behavior
When this skill is requested:
1. Redirect to `ML-product-operating-system-scaffold`.
