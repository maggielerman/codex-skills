...
## Naming Standard
- Use `DOCS/` as the canonical docs root for new and retrofitted scaffolds.
- Treat existing `docs/` or `documentation/` roots as migration sources.
...
## Projects
- `{{DOCS_ROOT}}/PROJECTS/`
- `{{DOCS_ROOT}}/PROJECTS/NNNN_project_template.md`
